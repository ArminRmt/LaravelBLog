  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<p class="pt-8 text-sm">Im mark a fullstack web developer</p>
	...
	<div class="w-full lg:w-2/5">
		<img src="https://images.unsplash.com/photo-1532074205216-d0e1f4b87368?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjF8fHByb2ZpbGV8ZW58MHx8MHx8&w=1000&q=80">
	</div>
...
</html><?php /**PATH D:\blogg\laravelblog\resources\views/components/profile.blade.php ENDPATH**/ ?>